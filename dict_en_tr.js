 ...
 * v0.14, +8 in v0.14.2, +326 in v0.14.17, +266 in v0.14.18, +214 in
 * v0.14.20 — 3,130 total, all checked against the full existing list
 * first so nothing silently overwrites an existing sense; see the file's
 * own gotchas below —
...
(function (global) {
  ...
  // v0.14.20 — dictionary growth batch (2026-08-19, 214 entries), per the
  // standing per-APK-update instruction. Pulled from climate/earth
  // science, conservation biology, public health/epidemiology, economics/
  // labor, migration/demographics, energy/sustainability, and corporate/
  // regulatory-accountability vocabulary common in science and policy
  // journalism — checked against the full existing list first, same
  // method as every prior batch.
  add({
    "glacial melt":"buzul erimesi",
    "permafrost thaw":"permafrost çözülmesi",
    "ice core":"buz karotu",
    "sediment core":"tortu karotu",
    "carbon sink":"karbon yutağı",
    "carbon sequestration":"karbon tutulumu",
    "deforestation rate":"ormansızlaşma oranı",
    "reforestation effort":"yeniden ormanlaştırma çabası",
    "soil erosion":"toprak erozyonu",
    "soil fertility":"toprak verimliliği",
    "crop yield":"ürün verimi",
    "crop rotation":"ekin nöbeti",
    "monoculture":"tek tür ekim",
    "pollinator decline":"tozlaştırıcı azalması",
    "invasive predator":"istilacı avcı",
    "keystone species":"anahtar tür",
    "apex predator":"üst avcı",
    "trophic cascade":"trofik basamak etkisi",
    "biodiversity hotspot":"biyoçeşitlilik sıcak noktası",
    "conservation status":"koruma statüsü",
    "captive breeding":"esaret altında üretim",
    "rewilding":"yeniden vahşileştirme",
    "habitat fragmentation":"habitat parçalanması",
    "migratory pattern":"göç örüntüsü",
    "breeding season":"üreme mevsimi",
    "mating behavior":"çiftleşme davranışı",
    "camouflage":"kamuflaj",
    "bioluminescence":"biyolüminesans",
    "symbiosis":"simbiyoz",
    "parasite":"parazit",
    "host organism":"konak organizma",
    "pathogen resistance":"patojen direnci",
    "antibiotic resistance":"antibiyotik direnci",
    "drug resistance":"ilaç direnci",
  ...
  add({
    ...
    "extinction event":"yok oluş olayı",
    "mass extinction":"kitlesel yok oluş",
    "geological era":"jeolojik dönem",
    "tectonic activity":"tektonik faaliyet",
    "volcanic ash":"volkanik kül",
    "magma chamber":"magma odası",
    "seismograph":"sismograf",
    "aftershock sequence":"artçı sarsıntı dizisi",
    "tsunami warning":"tsunami uyarısı",
    "storm surge":"fırtına dalgası",
    "hurricane season":"kasırga mevsimi",
    "wind speed":"rüzgar hızı",
    "atmospheric pressure":"atmosferik basınç",
    "barometric reading":"barometrik ölçüm",
    "jet stream":"jet akımı",
    "El Nino":"El Nino",
    "La Nina":"La Nina",
    "drought condition":"kuraklık koşulu",
    "water scarcity":"su kıtlığı",
    "desalination":"tuzdan arındırma",
    "groundwater depletion":"yeraltı suyu tükenmesi",
    "aquifer recharge":"akifer beslenmesi",
    "irrigation efficiency":"sulama verimliliği",
    "crop failure":"ürün kaybı",
    "famine risk":"kıtlık riski",
    "food waste":"gıda israfı",
    "food distribution":"gıda dağıtımı",
    "supply shortage":"arz kıtlığı",
    "price volatility":"fiyat oynaklığı",
    "market fluctuation":"piyasa dalgalanması",
    ...
    "wage stagnation":"ücret durgunluğu",
    "income inequality":"gelir eşitsizliği"
  });

  add({
    "wealth gap":"servet uçurumu",
    "social mobility":"sosyal hareketlilik",
    "generational wealth":"nesiller arası servet",
    "pension fund":"emeklilik fonu",
    "retirement age":"emeklilik yaşı",
    "social security":"sosyal güvenlik",
    "healthcare system":"sağlık sistemi",
    "universal coverage":"evrensel kapsama",
    "preventive care":"önleyici bakım",
    "chronic condition":"kronik durum",
    "comorbidity":"eş hastalık",
    "risk factor":"risk faktörü",
    "early detection":"erken teşhis",
    "screening program":"tarama programı",
    "diagnostic test":"tanı testi",
    "treatment protocol":"tedavi protokolü",
    "recovery rate":"iyileşme oranı",
    "survival rate":"sağkalım oranı",
    "mortality rate":"ölüm oranı",
    "life expectancy":"yaşam beklentisi",
    "public awareness":"kamu farkındalığı",
    "health campaign":"sağlık kampanyası",
    "vaccination campaign":"aşı kampanyası",
    "immunization schedule":"aşılama takvimi",
    "disease surveillance":"hastalık gözetimi",
    "epidemic curve":"salgın eğrisi",
    "transmission rate":"bulaşma oranı",
    "incubation stage":"kuluçka aşaması",
    "quarantine measure":"karantina önlemi",
    "lockdown policy":"kapanma politikası",
    "travel restriction":"seyahat kısıtlaması",
    "border closure":"sınır kapanması",
    "supply chain resilience":"tedarik zinciri dayanıklılığı",
    "manufacturing capacity":"üretim kapasitesi",
    "industrial output":"sanayi üretimi",
    "automation adoption":"otomasyon benimsenmesi",
    "labor shortage":"işgücü kıtlığı",
    "skills gap":"beceri açığı",
    "digital divide":"dijital uçurum",
    "internet access":"internet erişimi"
  });

  add({
    "broadband infrastructure":"geniş bant altyapısı",
    "connectivity gap":"bağlantı açığı",
    "rural access":"kırsal erişim",
    "urban density":"kentsel yoğunluk",
    "population growth":"nüfus artışı",
    "population decline":"nüfus azalması",
    "birth rate":"doğum oranı",
    "aging population":"yaşlanan nüfus",
    "demographic shift":"demografik değişim",
    "census data":"nüfus sayımı verisi",
    "migration pattern":"göç örüntüsü",
    "displacement crisis":"yerinden edilme krizi",
    "resettlement program":"yeniden yerleşim programı",
    "integration policy":"entegrasyon politikası",
    "cultural assimilation":"kültürel asimilasyon",
    "diaspora community":"diaspora topluluğu",
    "indigenous rights":"yerli halk hakları",
    "ancestral land":"atalardan kalma toprak",
    "land rights":"toprak hakları",
    "territorial dispute":"toprak anlaşmazlığı",
    "resource extraction":"kaynak çıkarımı",
    "mining operation":"madencilik faaliyeti",
    "drilling permit":"sondaj izni",
    "environmental impact":"çevresel etki",
    "impact statement":"etki beyanı",
    "mitigation measure":"azaltım önlemi",
    "remediation effort":"iyileştirme çabası",
    "cleanup operation":"temizleme operasyonu",
    "toxic spill":"toksik sızıntı",
    "chemical leak":"kimyasal sızıntı",
    "groundwater contamination":"yeraltı suyu kirliliği",
    "air pollutant":"hava kirletici",
    "particulate matter":"partikül madde",
    "emission standard":"emisyon standardı",
    "fuel efficiency":"yakıt verimliliği",
    "combustion engine":"içten yanmalı motor",
    "battery technology":"batarya teknolojisi",
    "charging infrastructure":"şarj altyapısı",
    "renewable capacity":"yenilenebilir kapasite",
    "wind farm":"rüzgar çiftliği"
  });
  ...
  add({
    ...
    "peak load":"zirve yük",
    "baseline emission":"temel emisyon",
    "net zero":"net sıfır",
    "carbon neutrality":"karbon nötrlüğü",
    "climate pledge":"iklim taahhüdü",
    "climate target":"iklim hedefi",
    "emissions trading":"emisyon ticareti",
    "carbon tax":"karbon vergisi",
    "green subsidy":"yeşil sübvansiyon",
    "clean technology":"temiz teknoloji",
    "circular economy":"döngüsel ekonomi",
    "recycling rate":"geri dönüşüm oranı",
    "waste management":"atık yönetimi",
    "landfill capacity":"çöp sahası kapasitesi",
    "plastic pollution":"plastik kirliliği",
    "single-use plastic":"tek kullanımlık plastik",
    "biodegradable material":"biyolojik olarak parçalanabilir malzeme",
    "compostable packaging":"kompostlanabilir ambalaj",
    "sustainable sourcing":"sürdürülebilir tedarik",
    "supply transparency":"tedarik şeffaflığı",
    "ethical sourcing":"etik tedarik",
    "fair trade":"adil ticaret",
    "labor standard":"işçi standardı",
    "child labor":"çocuk işçiliği",
    "forced labor":"zorunlu çalıştırma",
    "human trafficking":"insan kaçakçılığı",
    "modern slavery":"modern kölelik",
    "exploitation risk":"sömürü riski",
    "due diligence":"gerekli özen",
    "corporate accountability":"kurumsal hesap verebilirlik",
    "stakeholder engagement":"paydaş katılımı",
    "shareholder activism":"hissedar aktivizmi",
    "proxy vote":"vekaleten oy",
    "board oversight":"yönetim kurulu denetimi",
    "executive compensation":"üst düzey yönetici ücretlendirmesi"
  });

  add({
    "pay disparity":"ücret eşitsizliği",
    "gender pay gap":"cinsiyet ücret farkı",
    "workplace diversity":"işyeri çeşitliliği",
    "inclusion policy":"kapsayıcılık politikası",
    "anti-discrimination law":"ayrımcılık karşıtı yasa",
    "harassment policy":"taciz politikası",
    "whistleblower protection":"ihbarcı koruması",
    "regulatory compliance":"düzenleyici uyum",
    "enforcement action":"yaptırım eylemi",
    "consent decree":"rıza kararı",
    "class action":"toplu dava",
    "settlement agreement":"uzlaşma anlaşması",
    "punitive damage":"cezai tazminat",
    "statute of limitations":"zamanaşımı süresi"
  });
