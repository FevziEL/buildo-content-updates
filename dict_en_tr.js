 ...
 * v0.14, +8 in v0.14.2, +326 in v0.14.17 — 2,650 total, all checked against
 * the full existing list first so nothing silently overwrites an existing
 * sense; see the file's own gotchas below —
